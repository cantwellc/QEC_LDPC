...
//
//    RandomErrorGenerator _errorGenerator;
//
...
//        float corrected;
//        float syndromeErrorsX;
//        float syndromeErrorsZ;
//        float logicalErrorsX;
//        float logicalErrorsZ;
//        float convergenceFailx;
//        float convergenceFailZ;
//    };
//
...
//
//    static void InitVarNodesArray(FloatArray2d_h& varNodes_h, FloatArray2d_d& varNodes_d, const IntArray2d_h& parityCheckMatrix, const int NUM_CONCURRENT_THREADS, float errorProbability);
//    static void SetDeviceSyndrome(const std::vector<int>& syndrome_h, const IntArray2d_d& x_syndrome_array_d);
//    Statistics GetStatistics(int errorWeight, int numErorrs, float errorProbability, int maxIterations);
//};
